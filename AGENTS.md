...
当前并行里程碑为 M1-FIX（考勤功能补漏，IN_PROGRESS）与 M3（仓储库存数字化管理，IN_PROGRESS，M3-R0 / R1 / R2 已执行）。权威进度以 `docs/PROJECT_STATUS.md`、`docs/CURRENT_MILESTONE.md` 为准。
...
- 未经用户逐轮授权启动 M3-R3 及之后轮次、创建 M3 相关 DocType、编写 M3 业务代码或创建库存业务数据
