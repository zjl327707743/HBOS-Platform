...
class TestRoleMatrix(unittest.TestCase):
    ...
    def test_system_manager_is_read_only_not_quality_authority(self):
        self.assertFalse(wf.action_allowed("submit_result", wf.ROLE_SYSTEM))
        self.assertFalse(wf.action_allowed("approve_result", wf.ROLE_SYSTEM, scope="HBOS Stability Result"))
        self.assertFalse(wf.action_allowed("approve_change_major", wf.ROLE_SYSTEM))
        self.assertTrue(wf.action_allowed("get_result_ledger", wf.ROLE_SYSTEM))
        self.assertTrue(wf.action_allowed("get_stability_results", wf.ROLE_SYSTEM))
