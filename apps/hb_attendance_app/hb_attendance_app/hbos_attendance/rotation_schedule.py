...
相位锚点(起点当天班次, Owner 2026-09-10 确认两批均自 8/15 起算):
  设备动力部(2026-08-15):
    付全喜 10009025: 晚班   (15晚 16休 17早 18晚 19休 20早)
    李双胜 10009027: 休息   (15休 16早 17晚 18休 19早 20晚)
    贾正利 10009028: 早班   (15早 16晚 17休 18早 19晚 20休)
  生产部(2026-08-15):
    吕玉升 10010011: 晚班   (15晚 16休 17早 18晚 19休 20早)
    王飞   10010010: 休息   (15休 16早 17晚 18休 19早 20晚)
    袁式梅 10010013: 早班   (15早 16晚 17休 18早 19晚 20休)

  说明: 生产部相位原按 8/26 快照记录(吕玉升早/王飞晚/袁式梅休), 与 8/15 起算等价
  (8/26-8/15=11, 11%3=2, 相位整体平移 2 位)。Owner 2026-09-10 明确锚点为 8/15,
  故统一改为从 8/15 起算, 生成结果与原先完全一致(已逐日比对零差异)。
"""
