...
2. M1-R3F 已形成面向业务负责人的确认包，当前为 REVIEWING；9 项确认主题中 7 项必须确认，2 项可先按默认值推进。
3. M1-R4 保持 PLANNED，尚未启动；M1-R4 前必须完成 7 项阻塞性确认主题的业务口径确认或 Owner 临时拍板。
