...
本文件记录 M1 启动前必须满足的门禁条件。M1-R0 已按本门禁进入规划审查阶段，但尚未进入业务开发。
...
M1-R0 当前状态：REVIEWING。方案文件见 `docs/milestones/M1_R0_平台入口账号权限与本地化诊断方案.md`。
...
M0-REMOTE 已完成。M1-R0 已启动并等待审查；M1-R1 仍需用户在 M1-R0 审查通过后明确启动。
