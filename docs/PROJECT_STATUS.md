...
- M1-R4 已启动，当前为 REVIEWING，主文档 `docs/milestones/M1_R4_Demo技术方案与实施路线拆分.md` 已交付。
...
14. M1-R4：REVIEWING，Demo 技术方案与实施路线拆分已交付，等待 Codex 审查。
15. M1-R5：PLANNED，待用户授权启动。
