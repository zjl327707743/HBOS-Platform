...
5. M1-R3：REVIEWING，已执行 HRMS 原生考勤最小测试数据试运行，实际结论为 PARTIAL / BLOCKED。
6. M1-R4：PLANNED，尚未启动。
