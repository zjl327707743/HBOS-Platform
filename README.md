...
- M1-R4 Demo 技术方案与实施路线拆分为 REVIEWING，主文档已交付，等待 Codex 审查
...
6. M1-R4 当前为 REVIEWING；M1-R4 定位为 Demo 技术方案与实施路线拆分，后续 R5/R6/R7 按递进拆分。
