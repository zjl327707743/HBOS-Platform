...
- M0-R3D HRMS 能力盘点与 M1 考勤一期边界设计已完成，当前等待 Codex 审查

M0 阶段用于约束后续规划、执行、审查与验收。当前已完成 Frappe / ERPNext / Docker 最小环境启动验证、Frappe HR / HRMS 安装验证、HRMS 前端资源修复和 M1 考勤一期边界设计；M1 尚未启动，仍禁止创建海滨自定义 Frappe App、业务代码、飞书真实写入和前端驾驶舱。
