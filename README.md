...
- M1-R3F 业务口径确认包已完成文档交付，当前为 REVIEWING；9 项确认主题中 7 项必须确认，2 项可先按默认值推进
...
4. M1-R3F 已形成业务口径确认包，当前等待 Codex 审查；9 项确认主题中 7 项必须确认，2 项可先按默认值推进。
5. M1-R4 当前仅为 PLANNED，尚未启动；M1-R4 才考虑二次最小验证或报表设计。
